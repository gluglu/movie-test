import{_ as Re,C as we,n as Z,p as P,q as be,s as Te,x as ke,S as ye,y as Ee,z as Ae,A as Ue}from"./index-a8726147.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const ge="storage";function Vt(e,t,n){return e=P(e),Pt(e,t,n)}function zt(e){return e=P(e),Ct(e)}function Wt(e){return e=P(e),St(e)}function Kt(e,t){return e=P(e),Ft(e,t)}function Xt(e=ke(),t){e=P(e);const s=be(e,ge).getImmediate({identifier:t}),r=Te("storage");return r&&Ht(s,...r),s}function Ht(e,t,n,s={}){Mt(e,t,n,s)}function $t(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return new Y(n,s,r,t,ye)}function jt(){Re(new we(ge,$t,"PUBLIC").setMultipleInstances(!0)),Z(ne,se,""),Z(ne,se,"esm2017")}jt();export{Wt as a,Xt as g,zt as l,Kt as r,Vt as u};
